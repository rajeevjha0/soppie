...
const FooterSubscribeWidget = () => {
  ...
  return (
    <footer className="pt-24 pb-12 bg-gray-200">
      <div className="container mx-auto wide">
        <div className="flex flex-wrap">
          <div className="footer-single-widget mb-12 col flex-1">
            <div className="logo mb-9">
              <div className="font-bold text-4xl pb-4 sm:pb-0 text-blackish">Soppie</div>
            </div>
          ...
          <div className="footer-single-widget mb-12 col flex-1">
            <h5 className="text-xl font-medium">ABOUT</h5>
            <nav className="footer-single-widget__nav">
              <ul>
              <li className='mt-[13px]'>
                  <Link href="#" legacyBehavior>
                    <a className='text-base font-normal	'>About us</a>
                  </Link>
                </li>
                <li className='mt-[13px]'>
                  <Link href="#" legacyBehavior>
          ...
          <div className="footer-single-widget mb-12 col flex-1">
            <h5 className="text-xl font-medium">USEFUL LINKS</h5>
            <nav className="footer-single-widget__nav">
              <ul>
                <li className='mt-[13px]'>
                  <Link href="#" legacyBehavior>
          ...
          <div className="footer-single-widget mb-12 col flex-1">
            <h5 className="text-xl font-medium">FOLLOW US ON</h5>
          ...
          <div className="footer-single-widget space-mb--50 col subscribe">
            <div className="footer-subscribe-widget">
              <h2 className="footer-subscribe-widget__title text-3xl font-medium mb-[30px]">Subscribe.</h2>
              <p className="footer-subscribe-widget__subtitle mb-[35px]">
...
export default FooterSubscribeWidget;
